...
class APApplication : Application(), Thread.UncaughtExceptionHandler, ImageLoaderFactory {
    ...
    companion object {
        ...
        const val OVERLAYFS_MODE_FILE = "/data/adb/.overlayfs_mode_enable"
    ...
    override fun onCreate() {
        ...
        me.bmax.apatch.util.LauncherIconUtils.applySaved(this, sharedPreferences.getString("launcher_icon_variant", "classic"))
