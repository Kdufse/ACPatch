...
import me.yuki.apatch.APApplication.Companion.SUPERCMD
import me.yuki.apatch.BuildConfig
import me.yuki.apatch.apApp
import me.yuki.apatch.ui.screen.MODULE_TYPE
import java.io.File
...
fun listModules(): String {
    ...
    withNewRootShell{
       newJob().add("cp /data/user/*/me.yuki.apatch/patch/ori.img /data/adb/ap/ && rm /data/user/*/me.yuki.apatch/patch/ori.img")
